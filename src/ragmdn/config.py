...
class Settings(BaseSettings):
    ...
    #: Секунд на ответ модели. Локальная модель на процессоре отвечает
    #: десятками секунд, и умолчание httpx (5 секунд) обрывало бы каждый запрос.
    llm_timeout: float = 180.0
    #: Сколько найденных фрагментов передавать модели как контекст.
